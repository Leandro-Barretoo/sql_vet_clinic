...
INSERT INTO animals (
    ...
    escape_attempts,
    neutered,
    weight_kg) VALUES ('Gabumon', '2018-11-15', 2, true, 8);
...
INSERT INTO animals (
    ...
    escape_attempts,
    neutered,
    weight_kg) VALUES ('Pikachu', '2021-01-07', 1, false, 15.04);
...
INSERT INTO animals (
    ...
    escape_attempts,
    neutered,
    weight_kg) VALUES ('Devimon', '2017-05-12', 5, true, 11);
...
INSERT INTO animals (
    ...
    escape_attempts,
    neutered,
    weight_kg) VALUES ('Charmander', '2020-02-08', 0, false, -11);
...
INSERT INTO animals (
    ...
    escape_attempts,
    neutered,
    weight_kg) VALUES ('Plantmon', '2022-11-15', 2, true, -5.7);
...
INSERT INTO animals (
    ...
    escape_attempts,
    neutered,
    weight_kg) VALUES ('Squirtle', '1993-04-02', 3, false, -12.13);
...
INSERT INTO animals (
    ...
    escape_attempts,
    neutered,
    weight_kg) VALUES ('Angemon', '2005-06-12', 1, true, -45);
...
INSERT INTO animals (
    ...
    escape_attempts,
    neutered,
    weight_kg) VALUES ('Boarmon', '2005-06-07', 7, true, 20.4);
...
INSERT INTO visits (vets_id, animals_id, visit_date)
VALUES (2, 11, '2019-12-21');

INSERT INTO visits (vets_id, animals_id, visit_date)
VALUES (1, 11, '2020-08-10');

INSERT INTO visits (vets_id, animals_id, visit_date)
VALUES (2, 11, '2021-04-07');
